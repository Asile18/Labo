...
<div class="FormHostelOptions FormHostelGroups">
	...
	<div class="FormHostelRoomService FormHostelOptionsGroup">
		...
		<div class="FormHostelOptionsRadio">
			<input type="radio"  name="roomService" value="1">
			<label for="">OUI</label>
			<input type="radio"  name="roomService" value="0">
			<label for="">NON</label>
		</div>
...
<input type="radio" name="isDeleted" value="0">
<label for="">Oui</label>
<input type="radio" name="isDeleted" value="1" >
<label for="">Non</label>
	</div>	
