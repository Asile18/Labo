	...
	<form action="#" method="post">
		...
		<div class="rating">
				...
				<label>
					<input type="radio" name="hostelStars" value="6" <?php if($hostel["hostelStars"] == 6){ echo "checked";} ?> />
					<span class="icon">★</span>
					<span class="icon">★</span>
					<span class="icon">★</span>
					<span class="icon">★</span>
				...
				<label>
					<input type="radio" name="hostelStars" value="7" <?php if($hostel["hostelStars"] == 7){ echo "checked";} ?> />
					<span class="icon">★</span>
					<span class="icon">★</span>
					<span class="icon">★</span>
					<span class="icon">★</span>
...
<br>
		...
		<input type="radio" name="isDeleted" value="0" <?php if($hostel["isDeleted"] == 0){ echo "checked";} ?>>
		<label for="">Oui</label>
		<input type="radio" name="isDeleted" value="1" <?php if($hostel["isDeleted"] == 1){ echo "checked";} ?> >
		<label for="">Non</label>	
